...
func InitAPI() *gin.Engine {
	...
	handler.RegisterCommentsHandlers(ginServer, controllers.NewCommentsController())
	handler.RegisterInteractionsHandlers(ginServer, controllers.NewInteractionsController())
